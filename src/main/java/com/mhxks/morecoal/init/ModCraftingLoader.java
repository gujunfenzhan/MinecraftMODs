...
public class ModCraftingLoader {
    ...
    public ModCraftingLoader() {
        ...
        //添加无序合成  煤炭+钻石=煤炭钻石
        GameRegistry.addShapelessRecipe(stack,Items.COAL,Items.DIAMOND);
       ...
       registerTowItemStackToItem(new ItemStack(Items.COAL),new ItemStack(Items.DYE,1,4),ModItemLoader.DYE4_COAL);
        ...
        //钻石
        GameRegistry.addShapedRecipe(new ItemStack(ModBlockLoader.DIAMOND_COAL),"###","###","###",'#',ModItemLoader.DIAMOND_COAL);
        ItemStack stack2 = stack.copy();
        stack2.grow(8);
        GameRegistry.addShapelessRecipe(stack2,new ItemStack(ModBlockLoader.DIAMOND_COAL));

        GameRegistry.addShapedRecipe(new ItemStack(ModBlockLoader.SEVEN_COLOR_TORCH)
                ,"abc","def","ghg"
    ...
    public void registerTowItemToItem(Item material,Item material2,Item result){
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(result),material,material2);
    }
    ...
    public void registerNightItemToBlock(Item item,Item out){
        //item 物品
        //out 方块
        GameRegistry.addShapedRecipe(new ItemStack(out),"###","###","###",'#',item);
        GameRegistry.addShapelessRecipe(new ItemStack(item,9),out);
}
