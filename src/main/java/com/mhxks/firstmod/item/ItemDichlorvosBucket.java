...
public class ItemDichlorvosBucket extends Item
{

    private int capacity; // how much the bucket holds
    @Nonnull
    private ItemStack empty; // empty item to return and recognize when filling
    private boolean nbtSensitive;

    public ItemDichlorvosBucket()
    {
     ...
     */
    public ItemDichlorvosBucket(int capacity, @Nonnull ItemStack empty, boolean nbtSensitive)
    {
    ...
    @Deprecated
    @Nonnull
    public static ItemStack getFilledBucket(@Nonnull net.minecraftforge.fluids.UniversalBucket item, Fluid fluid)
    {
